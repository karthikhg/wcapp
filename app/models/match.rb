...
byebug
    ...
    if self.tie
      ...
      team1.losses += 1
      team2.points += 3
      # team2.nrr += (self.team2_total/self.team2_overs)-(self.team1_total/self.team1_overs)
      # team1.nrr += (self.team1_total/self.team1_overs)-(self.team2_total/self.team2_overs)
    end
